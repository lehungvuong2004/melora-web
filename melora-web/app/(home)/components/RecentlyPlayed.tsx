...
export default function RecentlyPlayed() {
  ...
  const renderHeader = () => (
    <div className="flex items-center justify-between mb-4 px-1">
      ...
      <Link href="/history" className="text-sm font-semibold text-neutral-400 hover:text-white transition group">
        Xem toàn bộ lịch sử <i className="fa-solid fa-chevron-right text-xs ml-1 transition-transform group-hover:translate-x-1"></i>
      </Link>
    </div>
  );
